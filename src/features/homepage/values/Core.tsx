      ...
      <CoreContainer>
        ...
        <CoreWrapper>
          ...
          <CoreCard
            ...
            value="Growth"
            text="By being aware of Customer's needs, building good customer relationships and effective communication, we have established our values and continue to grow our excellence."
          />
          <CoreCard
            img="\assets\icons8-light-on-100.png"
            value="Innovation"
            text="Our business culture is dynamic, empowering quality and responsibilities. We respect the knowledge, skills and ideas that each employee contributes to the team. We strive to offer the best innovative product and services to customer satisfaction."
          />
        </CoreWrapper>
      </CoreContainer>
    </>
